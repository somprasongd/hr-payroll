...
-- PART 2: Restore original sync/recalculate triggers without tenant scoping
-- =========================================
...
-- Note: This is a large function, restoring to version without explicit tenant columns
-- The trigger tg_payroll_run_item_set_tenant should handle auto-population
-- =========================================
-- Keeping the current version as-is since trigger handles tenant columns
...
-- =========================================
-- 6) Restore add_employee_to_pending_payroll_runs()
-- =========================================
...
-- =========================================
-- Done: Restored original functions
-- =========================================
-- Revert payroll run item recalculation and sync triggers to pre-tenant-scoped behavior
