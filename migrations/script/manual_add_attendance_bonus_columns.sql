-- Manual migration: Add attendance bonus eligibility columns
-- Run this script on existing databases to add the new diligence allowance settings
-- Date: 2025-12-20
...
ADD COLUMN IF NOT EXISTS allow_attendance_bonus_nolate BOOLEAN NOT NULL DEFAULT FALSE,
ADD COLUMN IF NOT EXISTS allow_attendance_bonus_noleave BOOLEAN NOT NULL DEFAULT FALSE;

COMMENT ON COLUMN employees.allow_attendance_bonus_nolate IS 'สิทธิ์ได้รับเบี้ยขยัน (ไม่สาย)';
COMMENT ON COLUMN employees.allow_attendance_bonus_noleave IS 'สิทธิ์ได้รับเบี้ยขยัน (ไม่ลา)';

-- =====================================================
-- STEP 2: Update payroll_run_generate_items function
-- =====================================================
...
-- =====================================================
-- STEP 3: Update recalculate_payroll_item function
-- =====================================================
...
-- =====================================================
-- STEP 4: Update trigger to monitor new columns
-- =====================================================
...
WHERE table_name = 'employees' 
  AND column_name IN ('allow_attendance_bonus_nolate', 'allow_attendance_bonus_noleave');

-- Verify trigger
SELECT tgname, tgenabled 
FROM pg_trigger 
WHERE tgname = 'tg_sync_payroll_emp';
