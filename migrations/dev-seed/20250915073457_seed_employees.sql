...
VALUES
  ('hr','ฝ่ายบุคคล',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('finance','การเงิน',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('sales','ฝ่ายขาย',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('it','ไอที',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('ops','ปฏิบัติการ',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user))
...
VALUES
  ('manager','ผู้จัดการ',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('lead','หัวหน้าทีม',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('analyst','นักวิเคราะห์',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('developer','นักพัฒนา',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user)),
  ('staff','พนักงาน',(SELECT company_id FROM default_tenant),(SELECT admin_id FROM admin_user),(SELECT admin_id FROM admin_user))
-- Partial unique index (active codes only) cannot be targeted directly; rely on any conflict
ON CONFLICT DO NOTHING;
...
default_tenant AS (
  ...
  FROM companies c
  JOIN branches b ON b.company_id = c.id AND b.is_default = TRUE
...
INSERT INTO employees (
  ...
  photo_id, employee_type_id, department_id, position_id, company_id, branch_id, base_pay_amount,
...
('FT-001', (SELECT id FROM person_title WHERE code='mr'), 'Arthit', 'Prasert',
 ...
 (SELECT id FROM department WHERE code='hr' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT id FROM employee_position WHERE code='manager' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT company_id FROM default_tenant), (SELECT branch_id FROM default_tenant),
 32000.00,
...
('FT-002', (SELECT id FROM person_title WHERE code='mrs'), 'Benjamas', 'Sooksai',
 ...
 NULL, (SELECT id FROM employee_type WHERE code='full_time'),
 (SELECT id FROM department WHERE code='finance' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT id FROM employee_position WHERE code='analyst' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT company_id FROM default_tenant), (SELECT branch_id FROM default_tenant),
 28000.00,
...
('FT-003', (SELECT id FROM person_title WHERE code='ms'), 'Chalida', 'Wongthai',
 ...
 NULL, (SELECT id FROM employee_type WHERE code='full_time'),
 (SELECT id FROM department WHERE code='hr' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT id FROM employee_position WHERE code='staff' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT company_id FROM default_tenant), (SELECT branch_id FROM default_tenant),
 25000.00,
...
('FT-004', (SELECT id FROM person_title WHERE code='mr'), 'Danai', 'Chanthep',
 ...
 NULL, (SELECT id FROM employee_type WHERE code='full_time'),
 (SELECT id FROM department WHERE code='sales' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT id FROM employee_position WHERE code='lead' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT company_id FROM default_tenant), (SELECT branch_id FROM default_tenant),
 40000.00,
...
('FT-006', (SELECT id FROM person_title WHERE code='mr'), 'Phuwanat', 'Meechai',
 ...
 NULL, (SELECT id FROM employee_type WHERE code='full_time'),
 (SELECT id FROM department WHERE code='it' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT id FROM employee_position WHERE code='developer' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT company_id FROM default_tenant), (SELECT branch_id FROM default_tenant),
 30000.00,
...
('PT-201', (SELECT id FROM person_title WHERE code='mr'), 'Anucha', 'Phromdee',
 ...
 (SELECT id FROM department WHERE code='ops' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT id FROM employee_position WHERE code='staff' AND deleted_at IS NULL AND company_id = (SELECT company_id FROM default_tenant) LIMIT 1),
 (SELECT company_id FROM default_tenant), (SELECT branch_id FROM default_tenant),
 120.00,
