...
-- IMPORTANT: Triggers and columns follow
...
ALTER TABLE employees DROP COLUMN IF EXISTS company_id CASCADE;
ALTER TABLE employees DROP COLUMN IF EXISTS branch_id CASCADE;
