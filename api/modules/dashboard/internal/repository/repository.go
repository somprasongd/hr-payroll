...
func (r *Repository) GetAttendanceSummary(ctx context.Context, tenant contextx.TenantInfo, startDate, endDate time.Time, groupBy string, departmentID *uuid.UUID) ([]AttendanceEntry, error) {
	db := r.dbCtx(ctx)
